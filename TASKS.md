...
| T06 | Integrate OS scheduling and permissions | Implementation complete; macOS XCTest and physical-device delivery validation pending. Saved enabled alarms reconcile to owned UserNotifications requests; permission denial, partial add failure, edit replacement, disable, and delete states are represented without claiming delivery success |
